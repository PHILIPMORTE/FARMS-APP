...
Write-ProjectFile 'supabase\migration-26.sql' @'
-- ============================================================================
--  FARMS — MIGRATION 26
...
Write-ProjectFile 'supabase\EMAIL-SETUP.md' @'
# Turning on email
...
Write-ProjectFile 'supabase\migration-27.sql' @'
-- ============================================================================
--  FARMS — MIGRATION 27
...
Write-ProjectFile 'supabase\test-email.sql' @'
-- ============================================================================
...
Write-ProjectFile 'supabase\migration-28.sql' @'
-- ============================================================================
--  FARMS — MIGRATION 28
...
# Holds the mail provider API key. Never commit this.
supabase/set-email-key.sql
...
Write-ProjectFile 'src\pages\admin\Account.tsx' @'
import { useCallback, useEffect, useState } from 'react'
import { toast } from 'sonner'
import { supabase } from '@/lib/supabase'
import { useAuth } from '@/context/AuthContext'
